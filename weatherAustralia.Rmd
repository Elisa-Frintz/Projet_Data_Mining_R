...
svm_fit_radial_final <- svm(formula = RainTomorrow~., data = train_final, kernel = "linear", type = "C-classification", scale = FALSE, cost = 1, gamma = 0.1)
...
svm_fit_poly_final <- svm(formula = RainTomorrow~., data = train_final, kernel = "linear", type = "C-classification", scale = FALSE, cost = 1, gamma = 1, degree = 2, coef0 = 1)
